\noindent\begin{tabularx}{\linewidth}{XXXX}
    ...
    \mintinline{latex}{\petitop}(*)                 & \detokenize{limites.tex}                                        & petit o en probabilité                                & $\petitop{n^{- \frac 1 5}}$ / $\petitop*{n^{- \frac 1 5}}$ \\ \\
    \mintinline{latex}{\grandop}(*)                 & \detokenize{limites.tex}                                        & grand O en probabilité                                & $\grandop{n^{- \frac 1 5}}$ / $\grandop*{n^{- \frac 1 5}}$ \\ \\
