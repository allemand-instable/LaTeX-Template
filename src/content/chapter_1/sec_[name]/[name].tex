\lorem\footnote{oui c'est vrai}\lorem sachant $\Gamma : \inlinefunc{E}[x]{F}[\Gamma(x)]$. soit $f : \inlinefunc{E}{F}[y]$ et $g : \inlinefunc*{x}[E^\star]{y}$.
...
% ⚠️ note that "+ Ж" in the end won't render properly, it needs to be either mathsf, mathit or mathbf, that's why we define commands instead of using utf8 chars directly
\begin{equation}
